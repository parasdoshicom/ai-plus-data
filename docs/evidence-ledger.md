...
| The 2026 public-work archive contains 34 verified channel publications through August 3 | [`../publications/2026.md`](../publications/2026.md) | Public LinkedIn activity records and Insight Extractor RSS entries | Public external source | Channel count includes cross-platform releases of the same underlying idea |
...
| Paras publicly shared that USCIS approved his EB-1A petition, which he said was based on work in Data & AI | [`founder.md`](./founder.md), [`external-evidence-of-impact.md`](./external-evidence-of-impact.md) | LinkedIn post | Public external source | Self-authored public statement; do not include private petition detail or treat it as independent outcome evidence |
