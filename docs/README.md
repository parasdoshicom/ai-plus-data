...
- [`ai-adoption-board-brief.md`](./ai-adoption-board-brief.md): one-page executive reporting format
- [`sample-monthly-cdo-review.md`](./sample-monthly-cdo-review.md): synthetic example of a monthly CDO review using fake metrics
